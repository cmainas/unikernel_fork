...
σύγχρονη επιστήμη υπολογιστών. Η κύρια τεχνολογία που χρησιμοποιείται,
	...
	για το λειτουργικό σύστημα στο οποίο εκτελούνται αυτές οι εφαρμογές. 
...
Μία ακόμη προσέγγιση στο θέμα είναι τα unikernels. Πρόκειται για μία εικόνα
	...
	Τα unikernels καταφέρνουν να έχουν γρήγορους χρόνους εκκίνησης και μικρή
	κατανάλωση μνήμης, χωρίς να θυσιάζεται η ασφάλεια
	Εν τούτοις, ένα πρόβλημα είναι ότι τα unikernels υποστηρίζουν μία και
...
In recent years cloud computing is one important chapter of modern commputer
	...
	virtualization. Virtualization allows a physical machine to
...
%%TODO: teleutaia protash sto aggliko, mhpws mporei na ginei kaluterh?
