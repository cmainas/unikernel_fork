...
An another technology to support cloud computing is the containers which offer
	lightweight virtualization, fast instantiation times, small per-instance
...
A further approach in cloud computing is unikernerls. Unikernels are
	...
	source code and the parts of an opperating system that are needed from
